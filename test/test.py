...
def main():
    ...
    gym = deeplabG1G2()
    gym.initialize(args)
    gym.load('/home/ben/mathfinder/PROJECT/AAAI2017/our_Method/v3/deeplab_feature_adaptation/checkpoints/Lip_to_July_lr_g1=0.00001_lr_g2=0.00000002_interval_g1=5_interval_d1=5_net_D=lsganMultOutput_D_if_adaptive=True_resume_decay=g2/best_Ori_on_B_model.pth')
    gym.eval()
